...
function Modal(){
    const { task, handleInput, createTask,isEditing,closeModal ,modalMode,activeTask,
        updateTask }= useTasks();
  ...
  useDetectOutside({
    ...
    return  (<div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      <form
        action=""
       ...
       >
          ...
          <input
            className="bg-[#F9F9F9] p-2 rounded-md border reize none"
            type="text"
            id="title"
